...
def main(argv=None):
    ...
    if FLAGS.pretrained_model_path is not None:
        ...
        variable_restore_op = slim.assign_from_checkpoint_fn(FLAGS.pretrained_model_path, tf.get_collection(tf.GraphKeys.MODEL_VARIABLES), ignore_missing_vars=True)
